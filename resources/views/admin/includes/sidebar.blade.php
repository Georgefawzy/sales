<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <img src="{{ asset('assets/admin/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-elevation-3"
     style="opacity: .8">
  <span class="brand-text font-weight-light">Balad El Ghareib</span>
  </a>
  <!-- Sidebar -->
  <div class="sidebar">
