...
<a href="{{ route('admin.inv_production_exchange.index') }}">   صرف الخامات للمطبخ</a>
@endsection
...
<div class="modal fade " id="Add_item_Modal">
   <div class="modal-dialog modal-xl" >
      <div class="modal-content bg-info">
         ...
         <div class="modal-body" id="Add_item_Modal_body" style="background-color: Orange !important; color:black;">
         </div>
...
<div class="modal fade " id="ModalApproveInvocie">
   <div class="modal-dialog modal-xl" >
      <div class="modal-content bg-info">
         ...
         <div class="modal-body" id="ModalApproveInvocie_body" style="background-color: Orange !important; color:black;">
         </div>
         <div class="modal-footer justify-content-between">
            <button type="button" class="btn btn-outline-light" data-dismiss="modal">اغلاق</button>
         </div>
